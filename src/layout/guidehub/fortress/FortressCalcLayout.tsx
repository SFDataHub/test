// UnderworldCalcLayout – GIF links, Panel/Tabelle rechts. Dropdown im Seiten-Scope.
// Keine globalen Styles, alle Hooks sind einfache Klassen, die in der Seiten-CSS gescoped werden.
    ...
    <section className={["container", className].filter(Boolean).join(" ")}>
      ...
      <div className="grid">
        <div className="content">
          ...
          {/* Row: GIF links – Panel/Tabelle rechts */}
